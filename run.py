...
for species in S[1:]:
    ...
    if species!="peach": continue
    if a > b: a, b = b, a
    cmd1 = "blast_to_raw.py ${BDIR}/${a}_${b}.blastz --write-filtered-blast --tandem_Nmax 10 --qbed=${DDIR}/$a.bed --sbed=${DDIR}/$b.bed >${a}_${b}.blastp.filtered"
    cmd2 = "synteny_score.py ${a}_${b}.blastp.filtered --qbed=${DDIR}/$a.bed --sbed=${DDIR}/$b.nolocaldups.bed >${RDIR}/${a}_${b}.synteny_score"
